...
class Settings(BaseSettings):
    ...
    request_timeout_seconds: float = Field(default=10.0, ge=1.0, validation_alias="PLACES_REQUEST_TIMEOUT_SECONDS")
    provider_max_retries: int = Field(default=2, ge=0, le=5, validation_alias="PLACES_PROVIDER_MAX_RETRIES")
